...
### If you find this project helpful, please consider giving it a star ⭐ and follow me on [GitHub](https://github.com/Harsh-dhawan17)  ) for more exciting projects like this! 🚀git add README.md
...
1. Fork and clone the repository from GitHub:
   ...
   ```bash
   git clone https://github.com/Harsh-dhawan17/chat-mind.git
    ```
